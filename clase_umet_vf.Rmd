...
ggplot(data = parques,aes(x=anio_mes,y=visitas,color=origen_visitantes))+
  ...
  labs(title = "Visitas (en miles) a parques nacionales según residencia",
       ...
       y = "Visitantes",
       colour="",
       caption = "FUENTE: Dirección Nacional de Mercados y Estadística, Ministerio de Turismo y Deportes, en base a datos suministrados por la Dirección de Mercadeo de la Dirección Nacional de Uso Público de la Administración de Parques Nacionales.") +
  theme(text = element_text(size = 14),
        plot.caption  = element_text(hjust = 0),
        plot.subtitle=element_text(colour = "grey29"),
        plot.title=element_text(hjust = 0,face = "bold"),
